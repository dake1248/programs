...
tree.column("姓名", width=30)          # #设置列
tree.column("年龄", width=10)
tree.column("身高", width=100)
tree.column("体重", width=500)
...
for i in range(50):
    tree.insert("", i, text="line"+str(i), values=("迪丽热巴", "29", "175", "61sssssssssssssssssssssssssssssssssssssssqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq"))
